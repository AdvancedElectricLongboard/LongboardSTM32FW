...
Drivers/STM32F1xx_HAL_Driver/Src/%.o: ../Drivers/STM32F1xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft '-D__weak=__attribute__((weak))' '-D__packed=__attribute__((__packed__))' -DUSE_HAL_DRIVER -DSTM32F103xB -I"C:/data/Test2/AdvancedElectricLongboard/Core/Inc" -I"C:/data/Test2/AdvancedElectricLongboard/Drivers/STM32F1xx_HAL_Driver/Inc" -I"C:/data/Test2/AdvancedElectricLongboard/Drivers/STM32F1xx_HAL_Driver/Inc/Legacy" -I"C:/data/Test2/AdvancedElectricLongboard/Middlewares/Third_Party/FreeRTOS/Source/include" -I"C:/data/Test2/AdvancedElectricLongboard/Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2" -I"C:/data/Test2/AdvancedElectricLongboard/Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM3" -I"C:/data/Test2/AdvancedElectricLongboard/Drivers/CMSIS/Device/ST/STM32F1xx/Include" -I"C:/data/Test2/AdvancedElectricLongboard/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
